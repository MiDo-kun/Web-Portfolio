const Contact = () => {
  return (
    <div className="w-[350px] mt-4 tablet-md:mx-auto mobile-lg:w-full mobile-lg:my-1">
      ...
      <p className=" pl-6 mobile-lg:pl-4 mb-3 text-sm font-poppins text-gray-300">You can send a message via email here.</p>
      ...
      <form action="https://getform.io/f/0ef5432c-7885-4e5d-9c4f-c19f4d1b4f46" method="POST" className="text-white mx-auto w-[75%] mobile-sm:w-[80%]">
        ...
        <textarea name="message" id="" cols="10" rows="4"
          className="w-full mb-1 p-2 rounded-sm bg-[#161b22] border border-zinc-400 outline-none text-xs resize-none"
          placeholder="Message Here..." required>
        </textarea>

        <button className="flex gap-2 mx-auto uppercase tracking-wider pl-3 pr-2 py-1 laptop-lg:mb-0 text-[#FF9000] hover:bg-gray-800 hover:rounded-md" type="submit">
